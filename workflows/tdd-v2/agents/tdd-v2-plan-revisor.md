...
1. `fed state update status test_implementing` を実行してステータスを更新
2. `fed notify implement.3 "計画が承認されました。テストの実装に進んでください。"` を実行して、テスト実装者にテスト実装を依頼する
