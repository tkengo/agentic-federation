...
description: Code reviewer agent (Gemini) that reviews refactored test code for quality, correctness, and adherence to the improvement plan.
model: opus
...
5. `fed notify agent-team.2 "完了: code_review_gemini"` で Refactorer に報告
